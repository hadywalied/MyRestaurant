...
public class SampleDataItem {
    ...
    public static Map<String, MyData> dataItemMap;
    private static void addItem(MyData item){
    ...
    static {
        ...
        addItem(new MyData(null, "Quinoa Salmon Salad", "Salads",
        ...
        addItem(new MyData(null, "Chef's Salad", "Salads",
        ...
        addItem(new MyData(null, "House Salad", "Salads",
        ...
        addItem(new MyData(null, "Garden Buffet", "Salads",
                "Choose from our fresh local, organically grown ingredients to make a custom salad.",
                4, 10, ""));

        addItem(new MyData(null, "Mini Cheeseburgers", "Starters",
        ...
        addItem(new MyData(null, "Panko Stuffed Mushrooms", "Starters",
        ...
        addItem(new MyData(null, "French Onion Soup", "Starters",
        ...
        addItem(new MyData(null, "Artichokes with Garlic Aeoli", "Starters",
        ...
        addItem(new MyData(null, "Parmesan Deviled Eggs", "Starters",
                "SOME SAY OUR EGGS ARE DEVILISHLY GOOD. I HAVE TO AGREE.\n" +
                        "These delectable little bites are made with organic eggs, fresh Parmesan, and chopped pine nuts.\"",
                5, 8, "deviled_eggs.jpg"));

        addItem(new MyData(null, "Classic Burger", "Entrees",
        ...
        addItem(new MyData(null, "Tomato Bruschetta Tortellini", "Entrees",
        ...
        addItem(new MyData(null, "Handcrafted Pizza", "Entrees",
        ...
        addItem(new MyData(null, "Barbecued Tofu Skewers", "Entrees",
        ...
        addItem(new MyData(null, "Fiesta Family Platter", "Entrees",
        ...
        addItem(new MyData(null, "Crème Brûlée", "Desserts",
